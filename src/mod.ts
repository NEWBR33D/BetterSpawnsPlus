                        ...
                        try
                        {
                            ...
                            if (this.config.otherOptions.enabled)
                            {
                                ...
                                if (this.config.otherOptions.airdrops.enabled)
                                {
                                    ...
                                    configsAirdrops.loot.itemCount.min = randomCrateItemCount;
                                    configsAirdrops.loot.itemCount.max = randomCrateItemCount;
                                    ...
                                    if (this.config.otherOptions.consoleLogs)
                                    {
                                        ...
                                        this.logger.log(`   > crate items: ${configsAirdrops.loot.itemCount.max}`, this.logInfo);
